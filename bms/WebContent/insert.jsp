...
<body>
	<div id="content">
		...
		<div id="bms_manager">- 학생등록 -</div>
		
		<form action="BmsInsert" method="POST" name="frminsert" id="frminsert">
			<div id="in_content">
				<div class="div_input">
					<label for="input_id">아이디: </label>
					<input type="text" id="input_id" name="input_id" class="bms_index" placeholder="ID를 입력">
					<span id="span_id" class="span_ck">ID를 입력하세요.</span>
				</div>
				
				<div class="div_input">
					<label for="input_name">이름: </label>
					<input type="text" id="input_name" name="input_name" class="bms_index" placeholder="이름을 입력">
					<span id="span_name" class="span_ck">이름 입력하세요.</span>
				</div>
				
				<div class="div_input">
					<label for="input_age">나이: </label>
					<input type="text" id="input_age" name="input_age" class="bms_index" placeholder="나이를 입력">
					<span id="span_age" class="span_ck">나이를 입력하세요.</span>
				</div>
				
				<div class="div_input">
					<label for="input_major">전공: </label>
					<input type="text" id="input_major" name="input_major" class="bms_index" placeholder="전공을 입력">
					<span id="span_major" class="span_ck">전공을 입력하세요.</span>
				</div>
				
				<div class="div_input">
					<label for="input_phone">핸드폰번호: </label>
					<input type="text" id="input_phone" name="input_phone" class="bms_index" placeholder="핸드폰번호를 입력">
			...
			<div class="div_index">
				<a href="#" id="insert_btn" class="btn_index btn13">등록</a>
